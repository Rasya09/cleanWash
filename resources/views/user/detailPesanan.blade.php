                        ...
                        <div class="card-title-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="20" viewBox="0 0 15 20"
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M6.5 0C4.98122 0 3.75 1.23122 3.75 2.75V4.75C3.75 5.16421 4.08579 5.5 4.5 5.5H10.5C10.9142 5.5 11.25 5.16421 11.25 4.75V2.75C11.25 1.23122 10.0188 0 8.5 0H6.5ZM5.25 2.75C5.25 2.05964 5.80964 1.5 6.5 1.5H8.5C9.19036 1.5 9.75 2.05964 9.75 2.75V4H5.25V2.75Z"
                                    fill="currentColor" />
                                <path
                                    d="M2.25346 2.85483C2.25371 2.71463 2.11335 2.61816 1.98693 2.67877C0.801611 3.24701 0 4.45697 0 5.83545V16.3249C0 18.0357 1.27431 19.4785 2.97197 19.6899C5.97904 20.0644 9.02096 20.0644 12.028 19.6899C13.7257 19.4785 15 18.0357 15 16.3249V5.83546C15 4.45679 14.2016 3.24669 13.0165 2.67855C12.8903 2.618 12.75 2.71422 12.75 2.85426V4.75001C12.75 5.99265 11.7426 7.00001 10.5 7.00001H4.5C3.25736 7.00001 2.25 5.99265 2.25 4.75001L2.25346 2.85483Z"
                                    fill="currentColor" />
                            </svg>
                        </div>
                    ...
                    <div class="laundry-info">
                        <div class="laundry-info__img-wrap">
                            <img src="{{ $pesanan->mitraLaundry->logo
                                ...
                                alt="{{ $pesanan->mitraLaundry->store_name }}" class="laundry-info__img">
                        </div>
                    ...
                    <div class="pickup-grid">
                        ...
                        <div class="pickup-box pickup-box--full">
                            <div class="pickup-box__label">
                                <svg width="12" height="12" fill="none" stroke="var(--red-500)"
                                    stroke-width="2" viewBox="0 0 24 24">
                                    <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z" />
                                    <circle cx="12" cy="10" r="3" />
                                </svg>
            ...
            <div class="detail-right">
                ...
                <section class="side-card">
                    ...
                    <div class="price-breakdown">
                        ...
                        @empty
                            <div class="price-row">
                                <span class="price-row__label" style="color:var(--neutral-400);font-size:12.5px;">Menunggu
                                    konfirmasi layanan…</span>
                            </div>
                        @endforelse
                        ...
                        @if ($pesanan->diskon > 0)
                            <div class="price-row price-row--discount">
                                ...
                                <span class="price-row__val">- Rp
                                    {{ number_format($pesanan->diskon, 0, ',', '.') }}</span>
                            </div>
                        @endif
                    </div>
                    ...
                    <div class="payment-status">
                        ...
                        <span
                            class="payment-status__badge {{ $pesanan->status_bayar === 'lunas' ? 'payment-status__badge--paid' : 'payment-status__badge--unpaid' }}">
                ...
                <section class="side-card">
                    ...
                    <div class="aksi-list">
                        ...
                        <button class="btn-aksi">
                            <div class="btn-aksi__icon">
                                <svg width="14" height="14" fill="none" stroke="currentColor"
                                    stroke-width="2" viewBox="0 0 24 24">
                                    <path
                                        d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 10.8a19.79 19.79 0 01-3.07-8.63A2 2 0 012.18 0h3a2 2 0 012 1.72c.13 1 .37 1.97.72 2.9a2 2 0 01-.45 2.11L6.09 7.91a16 16 0 006 6l1.18-1.18a2 2 0 012.11-.45c.93.35 1.9.59 2.9.72A2 2 0 0122 16.92z" />
                                </svg>
                            </div>
                            Hubungi Laundry
                        </button>
                        ...
                        @if ($pesanan->isMasuk())
                            <form method="POST" action="{{ route('user.pesanan.cancel', $pesanan->id) }}"
            ...
            <form action="{{ route('user.review.store', $pesanan->id) }}" method="POST" id="reviewForm">
                ...
                <div class="dpx-modal-actions">
                    <button type="button" class="dpx-modal-btn dpx-modal-btn--ghost"
                        onclick="document.getElementById('reviewModal').classList.remove('active')">Batal</button>
                    <button type="submit" class="dpx-modal-btn" style="background:var(--blue-600); color:white;">Kirim
                        Ulasan</button>
                </div>
            </form>
        </div>
