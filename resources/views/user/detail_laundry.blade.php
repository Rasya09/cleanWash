        ...
        <div class="dl-container">
            ...
            <section class="dl-hero">
                ...
                <div class="dl-hero-right">
                    @php
                        $photos = is_array($laundry->store_photos)
                            ? $laundry->store_photos
                            : json_decode($laundry->store_photos, true) ?? [];
                        $mainPhoto =
                            count($photos) > 0 ? asset('storage/' . $photos[0]) : asset('storage/' . $laundry->logo);
                    @endphp
                    <img src="{{ $mainPhoto }}" class="dl-main-img" alt="Foto utama laundry"
                        ...
                        @if (isset($laundry->services) && $laundry->services->count() > 0)
                            @foreach ($laundry->services as $service)
                                ...
                                <div class="dl-layanan-item">
                                    ...
                                    <span class="dl-layanan-price">Rp
                                        {{ number_format($service->base_price, 0, ',', '.') }}/{{ $unit }}</span>
                                </div>
                            @endforeach
                        @else
