...
@section('content')
    <div class="main">
        ...
        <main class="content">
            ...
            <div id="tambahLayananModal" class="modal-overlay" style="display: none; position: fixed; inset: 0; background: rgba(0,0,0,0.5); z-index: 999; align-items: center; justify-content: center;">
                <div class="tl-form-area" style="width: 100%; max-width: 600px; max-height: 90vh; overflow-y: auto; position: relative;">
                    <div class="tl-form-header" style="display: flex; justify-content: space-between; align-items: flex-start;">
                        <div>
                        ...
                        <button type="button" onclick="closeModal()" style="background: none; border: none; font-size: 24px; cursor: pointer; color: #64748b; line-height: 1;">&times;</button>
                    </div>
                    ...
                    <form id="multiStepForm" action="{{ route('mitra.store-layanan') }}" method="POST">
                        ...
                        <div class="tl-step-content" id="step1">
                            ...
                            <div class="tl-grid-2">
                                <div class="tl-field">
                                    <label class="tl-label">
                                        Harga Dasar <span class="tl-required">*</span>
                                    </label>
                                    <div class="tl-input-group">
                                        <span class="tl-addon">Rp</span>
                                        <input type="number" name="harga_dasar" class="tl-input" id="basePrice" min="0" required>
                                ...
                                <div class="tl-field">
                                    <label class="tl-label">
                                        Estimasi Pengerjaan <span class="tl-required">*</span>
                                    </label>
                                    <div class="tl-input-group">
                                        <input type="number" name="estimasi" class="tl-input" id="duration" min="1" required>
...
<script>
    function openModal() {
        const modal = document.getElementById('tambahLayananModal');
        modal.style.display = 'flex';
        // Reset form
        document.getElementById('multiStepForm').reset();
        document.getElementById('togglesWrapper').style.display = 'none';
        document.getElementById('wrapBatasOrderFields').style.display = 'none';
        document.querySelectorAll('.unit-addon').forEach(el => el.textContent = '/ Kg');
    }

    function closeModal() {
        document.getElementById('tambahLayananModal').style.display = 'none';
    }

    // Menutup modal jika user klik di luar form
