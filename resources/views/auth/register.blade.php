            ...
            <div class="form-wrap">
                ...
                <form action="{{ route('register') }}" method="POST">
                    ...
                    <div class="field">
                        ...
                        <input type="text" name="name" id="name" placeholder="Nama Lengkap" maxlength="32"
                            autocomplete="name" value="{{ old('name') }}" required />
                        <small id="nameCounter">0 / 32</small>
                    </div>
                    <!-- EMAIL -->
                    <div class="field">
                        <span class="field-icon">
                        ...
                        <input type="email" name="email" placeholder="Masukan Email" autocomplete="email"
                    ...
                    <div class="field phone-field">
                        ...
                        <input type="tel" name="phone" id="phone" placeholder="81111111111" min="12" maxlength="15"
                    ...
                    <div class="field">
                        ...
                        <input type="password" id="password" name="password" placeholder="Masukkan Password" maxlength="50"
                    ...
                    <div class="field">
                        ...
                        <input type="password" id="password" name="password_confirmation" placeholder="Konfirmasi Password"
        ...
        passwordInput.addEventListener('input', function(){
            ...
            if(
                ...
                Swal.fire({
                    ...
                    text:'Password maksimal 50 karakter'
                });
            }
