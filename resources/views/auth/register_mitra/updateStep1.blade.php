                ...
                <div class="grid">
                    ...
                    <div class="form-group full">
                        ...
                        <div class="hari-grid" style="margin-bottom: 15px;">
                            @php
                                $savedDays = old('operational_days', $mitra->operational_days) ?? [];
                        ...
                        <div class="jam-row">
                            <input type="time" name="open_time" value="{{ old('open_time', $mitra->open_time) }}" required>
                            <span class="jam-sep">-</span>
                            <input type="time" name="close_time" value="{{ old('close_time', $mitra->close_time) }}" required>
                        </div>
                    </div>
                    <!-- DESCRIPTION -->
                    <div class="form-group full">
