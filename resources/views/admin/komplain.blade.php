            ...
            <tr class="sel" onclick="selectRow(this)">
              ...
              <td>
                <div class="plcell">
                  ...
                  <div><div class="plname">Andi Pratama</div><div class="plphone">0812-3456-7890</div></div>
                </div>
              </td>
              <td><div class="tipecell"><div class="tipe-ico red">👕</div><div class="tipename">Pakaian Rusak</div></div></td>
              <td><div class="mc"><div class="mlogo blue">🧺</div><div class="mname">Laundry Bersih Sejahtera</div></div></td>
              ...
              <td><div class="acell"><button class="abtn v" onclick="openDetail(event)">👁</button><button class="abtn">⋯</button></div></td>
            </tr>
            ...
            <tr onclick="selectRow(this)">
              ...
              <td>
                <div class="plcell">
                  ...
                  <div><div class="plname">Siti Aisyah</div><div class="plphone">0821-9876-5432</div></div>
                </div>
              </td>
              <td><div class="tipecell"><div class="tipe-ico orange">🕐</div><div class="tipename">Terlambat Diambil</div></div></td>
              <td><div class="mc"><div class="mlogo teal">🔵</div><div class="mname">Quick Wash Laundry</div></div></td>
            ...
            <tr onclick="selectRow(this)">
              ...
              <td>
                <div class="plcell">
                  ...
                  <div><div class="plname">Budi Santoso</div><div class="plphone">0813-2345-6789</div></div>
                </div>
              </td>
              <td><div class="tipecell"><div class="tipe-ico blue">🧹</div><div class="tipename">Hasil Cucian Buruk</div></div></td>
              <td><div class="mc"><div class="mlogo green">🌿</div><div class="mname">Fresh &amp; Clean Laundry</div></div></td>
            ...
            <tr onclick="selectRow(this)">
              ...
              <td>
                <div class="plcell">
                  ...
                  <div><div class="plname">Dewi Lestari</div><div class="plphone">0822-1122-3344</div></div>
                </div>
              </td>
              <td><div class="tipecell"><div class="tipe-ico orange">📦</div><div class="tipename">Kehilangan Barang</div></div></td>
              <td><div class="mc"><div class="mlogo orange">🟠</div><div class="mname">LaundryKita</div></div></td>
            ...
            <tr onclick="selectRow(this)">
              ...
              <td>
                <div class="plcell">
                  ...
                  <div><div class="plname">Fahmi Hidayat</div><div class="plphone">0838-7766-5544</div></div>
                </div>
              </td>
              <td><div class="tipecell"><div class="tipe-ico red">😤</div><div class="tipename">Pelayanan Buruk</div></div></td>
              <td><div class="mc"><div class="mlogo purple">💜</div><div class="mname">CleanPro Laundry</div></div></td>
            ...
            <tr onclick="selectRow(this)">
              ...
              <td>
                <div class="plcell">
                  ...
                  <div><div class="plname">Rina Marlina</div><div class="plphone">0856-9988-7766</div></div>
                </div>
              </td>
              <td><div class="tipecell"><div class="tipe-ico gray">⏰</div><div class="tipename">Terlambat Selesai</div></div></td>
              <td><div class="mc"><div class="mlogo red">🔴</div><div class="mname">Rapi &amp; Wangi Laundry</div></div></td>
            ...
            <tr onclick="selectRow(this)">
              ...
              <td>
                <div class="plcell">
                  ...
                  <div><div class="plname">Dimas Saputra</div><div class="plphone">0811-2233-4455</div></div>
                </div>
              </td>
              <td><div class="tipecell"><div class="tipe-ico green">🏷️</div><div class="tipename">Harga Tidak Sesuai</div></div></td>
              <td><div class="mc"><div class="mlogo indigo">📍</div><div class="mname">Super Laundry Express</div></div></td>
            ...
            <tr onclick="selectRow(this)">
              ...
              <td>
                <div class="plcell">
                  ...
                  <div><div class="plname">Hendra Wijaya</div><div class="plphone">0812-6677-8899</div></div>
                </div>
              </td>
              <td><div class="tipecell"><div class="tipe-ico gray">⋯</div><div class="tipename">Lainnya</div></div></td>
              <td><div class="mc"><div class="mlogo cyan">🔷</div><div class="mname">Laundry Baik Hati</div></div></td>
    ...
    <aside class="detail" id="detailPanel">
      ...
      <div class="detbody">
        ...
        <div class="dsec">
          ...
          <div class="drows">
            <div class="drow"><span class="drow-l">Nama</span><span class="drow-r">Andi Pratama</span></div>
            <div class="drow"><span class="drow-l">No. WhatsApp</span><span class="drow-r">0812-3456-7890 📱</span></div>
            <div class="drow"><span class="drow-l">Email</span><span class="drow-r">andi.pratama@email.com</span></div>
            <div class="drow"><span class="drow-l">Alamat</span><span class="drow-r">Jl. Melati No. 12, Cipete Jakarta Selatan</span></div>
          </div>
        </div>
        ...
        <div class="dsec">
          ...
          <div class="drows">
            <div class="drow"><span class="drow-l">Order ID</span><span class="drow-r primary">#ORD-2024-0508-0001</span></div>
            <div class="drow"><span class="drow-l">Mitra Laundry</span><span class="drow-r">Laundry Bersih Sejahtera</span></div>
            <div class="drow"><span class="drow-l">Tgl Order</span><span class="drow-r">7 Mei 2024, 14:10</span></div>
            <div class="drow"><span class="drow-l">Tgl Selesai</span><span class="drow-r">8 Mei 2024, 09:20</span></div>
            <div class="drow"><span class="drow-l">Total Bayar</span><span class="drow-r">Rp85.000</span></div>
          </div>
        </div>
        ...
        <div class="dsec">
          ...
          <div class="tp-grid">
            <div class="tp-row"><span class="tp-label">Tipe Laporan</span><span class="tp-val">Pakaian Rusak</span></div>
            <div class="tp-row"><span class="tp-label">Prioritas</span><span class="prio high">Tinggi</span></div>
          </div>
        </div>

        <div class="dsec">
          <div class="dsec-title"><div class="si red">📝</div> Deskripsi Laporan</div>
          <div class="desc-text">Pakaian saya (kemeja putih) rusak pada bagian lengan setelah dicuci. Mohon ganti rugi atau perbaikan.</div>
          <div class="photos">
...
<script>
  ...
  function closeDetailPanel() {
    ...
    document.body.style.overflow = '';
    if (!isMobile()) detailPanel.style.display = 'flex';
  }

  closeDetailBtn.addEventListener('click', closeDetailPanel);
  detailBackdrop.addEventListener('click', closeDetailPanel);

  /* Desktop → panel always visible; Mobile → hidden until opened */
  ...
  window.addEventListener('resize', applyDetailMode);
  applyDetailMode();
