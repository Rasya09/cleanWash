...
<body>
  <div class="app">
    ...
    <main class="main">
      ...
      <header class="topbar">
        <div class="top-left">
          <!-- Tombol Hamburger: fungsional di semua ukuran -->
        ...
        <div class="top-right">
          <!-- Notification Bell -->
          <button class="icon-bell" aria-label="Notifikasi">
      ...
      <div class="scroll-area">
        ...
        <section class="content-grid">
          ...
          <!-- ── LEFT PANEL: Daftar Menunggu Verifikasi ── -->
          <div class="panel list-panel">
            ...
            <div class="pending-list">
              ...
              <div class="pending-item">
                ...
                <div class="pending-text">
                  <div class="pending-name">Kilat Laundry Service</div>
                  <div class="pending-city">Bandung</div>
                  <div class="pending-date">Didaftarkan: 5 Mei 2024, 14:55</div>
                </div>
                <span class="pill orange">Menunggu</span>
              </div>
            ...
            <div class="pagination-wrap">
              ...
              <div class="pagination">
                <button aria-label="Sebelumnya"><i class="fa-solid fa-chevron-left"></i></button>
                <button class="active">1</button>
                <button>2</button>
                <button>3</button>
                <button>4</button>
                <button>5</button>
                <button aria-label="Selanjutnya"><i class="fa-solid fa-chevron-right"></i></button>
              </div>
            </div>
          </div>
          <!-- /.list-panel -->

          <!-- ── RIGHT PANEL: Detail Pendaftaran ── -->
          <div class="panel detail-panel">

            <!-- Header Detail + Tombol Aksi -->
            ...
            <div class="partner-card">
              <div class="partner-avatar">
                <img src="https://i.pravatar.cc/160?img=1" alt="Mitra Avatar" />
              </div>
            ...
            <!-- Info Grid: Informasi Laundry + Dokumen -->
            <div class="info-grid">
              ...
              <div class="info-box">
                ...
                <div class="info-list">
                  ...
                  <div class="info-row">
                    ...
                    <span>Email</span>
                    <b>bersihjsejahtera@gmail.com</b>
                  </div>
                  <div class="info-row">
                  ...
                  <div class="info-row">
                    ...
                    <span>Alamat</span>
                    <b>Jl. Kemang Raya No. 12, Bangka, Mampang Prapatan, Jakarta Selatan</b>
                  </div>
                  <div class="info-row">
                  ...
                  <div class="info-row">
                    ...
                    <span>Radius Antar Jemput</span>
                    <b>5 km</b>
                  </div>
                  <div class="info-row">
                    <i class="fa-solid fa-weight-scale"></i>
                    <span>Minimum Berat</span>
                    <b>3 Kg</b>
                  </div>
                  <div class="info-row">
                    <i class="fa-solid fa-credit-card"></i>
                    <span>Metode Pembayaran</span>
                    <b>QRIS, Transfer Bank, Tunai</b>
                  </div>
                </div>
              </div>
              ...
              <div class="info-box">
                ...
                <div class="doc-list">
                  ...
                  <div class="doc-row">
                    ...
                    <button class="eye-btn" aria-label="Lihat dokumen"><i class="fa-regular fa-eye"></i></button>
                  </div>
            ...
            <!-- Galeri Foto Tempat Laundry -->
            <div class="photo-box">
              <h4>Foto Tempat Laundry</h4>
              <div class="photo-list">
                <img src="https://images.unsplash.com/photo-1527515637462-cff94eecc1ac?auto=format&fit=crop&w=400&q=80" alt="Foto laundry 1" />
                <img src="https://images.unsplash.com/photo-1581578731548-c64695cc6952?auto=format&fit=crop&w=400&q=80" alt="Foto laundry 2" />
                <img src="https://images.unsplash.com/photo-1517677208171-0bc6725a3e60?auto=format&fit=crop&w=400&q=80" alt="Foto laundry 3" />
                <img src="https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?auto=format&fit=crop&w=400&q=80" alt="Foto laundry 4" />
  ...
  <script>
    ...
    // Auto-close saat resize ke desktop besar
